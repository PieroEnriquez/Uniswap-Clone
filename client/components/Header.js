...
const style = {
  ...
  navItem: 'px-4 py-2 m-1 flex items-center text-lg font-semibold cursor-pointer rounded-3xl',
  activeNavItem: 'bg-[#20242A]',
  buttonsContainer: 'flex w-1/4 justify-end items-center',
  button: 'flex items-center bg-[#191B1F] rounded-2xl mx-2 text[0.9rem] cursor-pointer',
  buttonPadding: 'p-2',
  ...
  return (
    <div className={style.wrapper}>
      ...
      <div className={style.buttonsContainer}>
        ...
        {currentAccount ? (
          <div className={`${style.button} ${style.buttonPadding}`}>
            <div className={`${style.buttonTextContainer}`}>{'0x88...5cd'}</div>
          </div>
        ) : (
          <div
